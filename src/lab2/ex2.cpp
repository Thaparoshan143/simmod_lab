...
// only frequency/range is changed compared to 'ex1.cpp'
int main(int argc, char* argv[])
{
    ...
    const uint freq_max { 10 }; // in logspace
    const uint samp_count { 100 };

    // frequency response analysis @2
    // const uint freq_min { 0} ; // eq. to 10e0
    // const uint freq_max { 1 }; // in logspace 
    // const uint samp_count { 5000 };
    ...
    // auto phase = GetComplexVecPhase(H_overall); // radian based
